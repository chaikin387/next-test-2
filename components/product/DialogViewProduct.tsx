...
export function DialogViewProduct({ product, cartItems, initialVariantId, isCartModal }: Props) {
	...
	return (
		<div className='flex flex-col items-stretch gap-8 md:flex-row'>
			<div className='bg-muted-foreground/10 pointer-events-none relative aspect-square w-full overflow-hidden rounded-2xl md:w-1/2'>
				<Image
					...
					className='object-contain p-12 select-none'
				/>
			</div>
			...
			<div className='flex flex-1 flex-col'>
				...
				<div className='mt-auto mb-4 flex items-center justify-between rounded-xl border p-4'>
					<div>
